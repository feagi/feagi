...
def run_test_mode(core_api_service, **kwargs):
    ...
    """
    logger.warning("⚠️  DEPRECATION WARNING: feagi.test_mode.run_test_mode is deprecated")
    ...
    logger.warning("   See feagi_core/feagi/utils/test_mode/README.md for full documentation")
