...
class LZ4Compressor:
    ...
    def __init__(
        ...
        if not self.config_enabled:
            ...
            if self.require_lz4:
                ...
                raise ImportError("LZ4 compression is required but lz4 package is not installed")
            else:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self._stats_lock:
            ...
            bytes_saved = max(0, self.stats['total_bytes_in'] - self.stats['total_bytes_out'])
            ...
            return {
                ...
                'bytes_saved': bytes_saved,
                'compression_ratio': self.stats['total_bytes_out'] / max(self.stats['total_bytes_in'], 1),
                'bandwidth_savings_percent': (bytes_saved / max(self.stats['total_bytes_in'], 1)) * 100,
                'avg_compression_time_ms': self.stats['total_time_ms'] / total_compressions,
                ...
                'success_rate': ((self.stats['total_compressions'] - self.stats['failed_compressions']) / total_compressions) * 100
            }
