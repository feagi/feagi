...
"""
FastAPI Genome Router - Auto-Generated from v1 API

This router is automatically generated from decorated v1 API endpoints.
NO endpoint definitions exist here - they are all in /api/v1/genome.py
...
from feagi.api.transport.universal_fastapi import get_genome_router
...
router = get_genome_router()

# Note: All endpoint implementations are in:
# - Single Source of Truth: feagi.api.v1.genome.GenomeAPI (decorated methods)
