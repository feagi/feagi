...
from ..memory import NeuralBufferPool, Buffer
from ..platform import optimize_socket_for_neural_data
from feagi.utils.logger import setup_logger
from feagi.utils.zmq_debug import log_inbound, MessageType
    ...
    async def _handle_neuron_flat(
        ...
        try:
            ...
            firing_rates = np.frombuffer(
                payload[offset:offset + neuron_count * 4],
                dtype=np.float32
            )
            ...
            try:
                result = await self.core_api.inject_neural_data(
                    ...
                    coordinates=(x_coords, y_coords, z_coords) if header.has_coordinates else None,
