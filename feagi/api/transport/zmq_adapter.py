...
if EMBEDDED_MODE:
        ...
        async def process_message(self, request_json):
            ...
            try:
                ...
                if route == '/v1/system/health_check' and method == 'GET':
                    ...
                    return self._create_error_response(503, "Advanced REST API disabled in embedded mode")
                    
            except Exception as e:
                return self._create_error_response(500, f"Error in embedded mode handler: {str(e)}")
    ...
    class ZMQRestAdapter:
        ...
        async def _handle_get_agent_properties_query(self, params, query, body, headers):
