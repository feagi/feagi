...
from .schemas import (
    NeuroplasticityRulesResponse, NeuroplasticityStatsResponse, 
    UpdateNeuroplasticityRequest, SuccessResponse, ErrorResponse
)
...
def neuroplasticity_endpoint(methods, path, request_model=None, response_model=None, description=None):
...
class NeuroplasticityAPI:
    ...
    @neuroplasticity_endpoint('POST', '/enable/{area_id}', response_model=SuccessResponse)
    async def enable_area_plasticity(self, area_id: str, settings: Dict[str, Any] = None) -> SuccessResponse:
        ...
        try:
            ...
            raise ValueError(f"Failed to enable plasticity for area {area_id}: {str(e)}")
    
    @neuroplasticity_endpoint('POST', '/disable/{area_id}', response_model=SuccessResponse)
    async def disable_area_plasticity(self, area_id: str) -> SuccessResponse:
        ...
        try:
            ...
            raise ValueError(f"Failed to disable plasticity for area {area_id}: {str(e)}")
    ...
    @neuroplasticity_endpoint('PUT', '/plasticity_queue_depth', response_model=SuccessResponse)
