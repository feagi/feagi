...
class SimulationAPI:
    ...
    @simulation_endpoint('POST', '/upload/string', 
                        request_model=Stimulation,
                        response_model=SuccessResponse)
    def stimulation_string_upload(self, stimulation_script: Stimulation) -> SuccessResponse:
        """
        ...
        """
        try:
            success = self.core_api_service.upload_stimulation_script(stimulation_script.stimulation_script)
            if not success:
