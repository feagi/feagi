...
polygon_3 = visual.Rect(
    ...
    width=[-200/2,-100/2][0], height=[-200/2,-100/2][1],
...
trialComponents = [dots, polygon, polygon_2, mouse, polygon_3]
...
while continueRoutine:
    ...
    if polygon_3.status == STARTED:  # only update if drawing
        polygon_3.setPos([capabilities['camera']['field_of_vision_origin'][0],capabilities['camera']['field_of_vision_origin'][1]], log=False)
