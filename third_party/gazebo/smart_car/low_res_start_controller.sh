...
then
    ...
    xterm -hold -e "cd /opt/source-code/freenove_4wd_car_description/ && source install/setup.bash && ros2 launch freenove_4wd_car_description low_res_freenove_smart_car.launch.py"
