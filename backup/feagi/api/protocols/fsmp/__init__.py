...
from feagi.api.protocols.fsmp.common import FSMPChannelType, FSMPDataType, FSMPMessageFormat
...
def create_sensory_data_message(channel_id: int, cortical_id: str, activations: List[float]) -> Dict[str, Any]:
    """
...
def create_motor_data_message(channel_id: int, cortical_id: str, activations: List[float]) -> Dict[str, Any]:
    """
...
def create_neuron_potential_message(cortical_areas: List[Dict[str, Any]]) -> Dict[str, Any]:
    """
