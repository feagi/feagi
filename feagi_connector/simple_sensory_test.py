...
logger = logging.getLogger("feagi_sensory_test")
...
def simple_sensory_test():
    """Run a simple test for sending sensory data"""
    logger.info("Starting FEAGI sensory test")
    ...
    logger.info("Sensory test completed")
