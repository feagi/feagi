...
main() {
    ...
    case "$TARGET" in
        ...
        --help|help|-h)
            ...
            echo "  feagi-bdu        Build BDU"
            echo "  feagi-pns        Build PNS"
            echo "  feagi-plasticity Build plasticity"
            echo "  feagi-types      Build types"
            echo "  feagi-zmq-server Build ZMQ server"
