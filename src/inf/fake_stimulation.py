...
stimulation_data = {
    ...
    402: {"motor_opu": ["2-0-8"]},
    403: {"motor_opu": ["3-0-0"]},
    500: {"motor_opu": ["0-0-15"]},
    501: {"motor_opu": ["1-0-12"]},
    502: {"motor_opu": ["2-0-19"]},
    503: {"motor_opu": ["3-0-17"]},
    600: {"motor_opu": ["0-0-15"]},
    601: {"motor_opu": ["1-0-12"]},
    602: {"motor_opu": ["2-0-19"]},
    603: {"motor_opu": ["3-0-17"]},
    }
