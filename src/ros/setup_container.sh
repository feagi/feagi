...
cp $mypath/ros_laser_scan.py $mypath/HC_SR04_Foxy.py $mypath/Sonar_reader1.py $mypath/Sonar_reader.py $mypath/micro-ros_publisher/ $mypath/ardiunotopython/ $mypath/ros_teleop.py ~/ros2_ws/src/py_topic/py_topic/
