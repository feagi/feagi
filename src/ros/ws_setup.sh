...
cp -R $mypath/ros_laser_scan.py $mypath/ros_teleop.py $mypath/Micro-ROS/micro-ros.py ~/feagi-core/src/arduino/ardiunotopython/py2arduino.py ~/ros2_ws/src/py_topic/py_topic/
