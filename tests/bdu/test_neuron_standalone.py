...
class Neuron:
    ...
    def __init__(self, neuron_id, area_id, position, threshold=1.0, 
                 membrane_potential=0.0, decay_rate=0.5, **kwargs):
        """
    ...
    def from_dict(cls, data):
        ...
        for key, value in data.items():
            if key not in ["id", "area_id", "position", "threshold", 
...
class NeuronArray:
    ...
    def create_neuron(self, area_id, position, threshold=1.0, 
                     membrane_potential=0.0, decay_rate=0.5):
        """
