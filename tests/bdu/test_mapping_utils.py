...
def test_build_power_connections(mock_state_manager):
    ...
    with patch('feagi.bdu.connectivity.mapping_utils.cortical_types', {
        'custom': {
            'supported_devices': {
                'target_area': {
        ...
        patterns = mock_instance.genome["neuron_morphologies"][morphology_name]["parameters"]["patterns"]
