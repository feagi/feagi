...
def connectome_manager():
    ...
    cm.get_neurons_by_cortical_area.side_effect = lambda cortical_id: list(cm.cortical_neuron_map.get(cortical_id, []))
    cm.get_cortical_area_for_neuron.side_effect = lambda neuron_id: cm.neurons[neuron_id]["cortical_id"]
