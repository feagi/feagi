...
def test_transaction_commit():
    ...
    transaction.record_change(
        "update_cortical_area", "test_id", {"old": "value"}, {"new": "value"}
    )
...
def test_transaction_rollback():
    ...
    # Mock needed methods
    with patch.object(transaction, "_set_at_path") as mock_set, patch.object(
        transaction, "_synchronize_connectome"
    ):
        transaction.record_change(
