...
class TestBurstEngineComprehensive(unittest.TestCase):
    ...
    def test_run_with_fire_queue_not_ready(self, mock_perf_counter, mock_sleep):
        ...
        self.mock_state_manager.get_burst_engine_state.return_value = ServiceState.UNAVAILABLE
    ...
    @patch('feagi.npu.burst_engine.time.sleep')
    @patch('feagi.npu.burst_engine.time.perf_counter')
    def test_run_with_fire_queue_optimized_path(self, mock_perf_counter, mock_sleep, mock_logger):
        ...
        def patched_run_with_fire_queue_optimized(mpf=True, puf=False, max_consecutive_fires=10):
            """Modified version for testing optimized path"""
            if self.burst_engine.state_manager.get_burst_engine_state() != ServiceState.READY:
                return False
            ...
            while self.burst_engine._running:
                ...
                if self.burst_engine.desired_frequency > 0 and elapsed < self.burst_engine.burst_interval:
        ...
        try:
            ...
            # Call the method
            result = self.burst_engine.run_with_fire_queue(mpf=True, puf=False, max_consecutive_fires=5)
    ...
    @patch('feagi.npu.burst_engine.time.sleep')
    @patch('feagi.npu.burst_engine.time.perf_counter')
    def test_run_with_fire_queue_optimized_no_core(self, mock_perf_counter, mock_sleep, mock_logger):
        ...
        def patched_run_with_fire_queue_no_core(mpf=True, puf=False, max_consecutive_fires=10):
    ...
    @patch('feagi.npu.burst_engine.time.sleep')
    @patch('feagi.npu.burst_engine.time.perf_counter')
    def test_run_with_fire_queue_fallback_path(self, mock_perf_counter, mock_sleep, mock_logger):
        ...
        def patched_run_with_fire_queue_fallback(mpf=True, puf=False, max_consecutive_fires=10):
    ...
    @patch('feagi.npu.burst_engine.time.sleep')
    @patch('feagi.npu.burst_engine.time.perf_counter')
    def test_run_with_fire_queue_sleep_for_timing(self, mock_perf_counter, mock_sleep, mock_logger):
        ...
        def patched_run_with_fire_queue_sleep(mpf=True, puf=False, max_consecutive_fires=10):
    ...
    def test_run_with_fire_queue_no_sleep_if_slow(self, mock_perf_counter, mock_sleep):
        ...
        def patched_run_with_fire_queue_no_sleep(mpf=True, puf=False, max_consecutive_fires=10):
