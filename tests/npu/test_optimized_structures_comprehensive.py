...
class MockRustConnectome:
    ...
    def add_connection(self, source_id, target_id, weight, delay=0, connection_type=0, 
                      source_cortical_idx=0, target_cortical_idx=0):
...
def test_connectome_add_connection_rust(mock_rust_available):
    ...
    connectome.add_connection(0, 1, 0.5, delay=1, connection_type=0, 
                            source_cortical_idx=0, target_cortical_idx=0)
...
def test_optimized_feagi_core_propagate_activations_numpy_no_firing(mock_rust_unavailable):
