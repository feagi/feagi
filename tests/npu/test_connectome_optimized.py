...
class TestConnectome:
    ...
    def rust_connectome(self):
        ...
        with patch('feagi.npu.optimized_structures.RUST_AVAILABLE', True), \
             patch('feagi.npu.optimized_structures.create_connectome', return_value=MockRustConnectome(1000, 5000)):
            return Connectome(1000, 5000)
    ...
    def test_propagate_activations_rust(self, rust_connectome):
        ...
        # Propagate activations
        result = rust_connectome.propagate_activations(source_activations, target_buffer)
...
class TestOptimizedFeagiCore:
    ...
    def test_propagate_activations(self, rust_core):
        ...
        rust_core._rust_core.connectome.propagate_activations = Mock(return_value=[0.1, 0.2, 0.3])
