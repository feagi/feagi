...
from feagi.npu.fcl_manager import FCLManager, EnhancedFCLManager, BitMap, CorticalIdx
...
class TestFCLManager:
    ...
    def test_window_wrapping(self, fcl_manager, sample_firing_data):
        ...
        global_fcl_oldest_valid = fcl_manager.get_global_fcl(timestep=3)  # Should be valid
...
class TestEnhancedFCLManager:
    ...
    def test_area_fcl_history(self, enhanced_fcl_manager, sample_firing_data):
        ...
        window_size, history_array, start_timestep = enhanced_fcl_manager.custom_cortical_history[100]
    ...
    def test_register_memory_cortical(self, enhanced_fcl_manager):
        ...
        with pytest.raises(ValueError):
            enhanced_fcl_manager.register_memory_cortical(600, window_size=3)  # Too small
