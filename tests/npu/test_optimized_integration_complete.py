...
class TestCreateOptimizedCore:
    ...
    def test_create_optimized_core(self):
        ...
        with patch('feagi.npu.optimized_integration.RUST_AVAILABLE', True), \
             patch('feagi.npu.optimized_integration.OptimizedFeagiCore') as mock_optimized_core:
            mock_instance = Mock()
...
class TestStepSimulationWithFireQueue:
    ...
    def test_step_simulation_with_fire_queue_dict(self, dict_core):
        ...
        # Setup connections
        dict_core["connectome"].get_connections_for_neuron = Mock(side_effect=[
            [{"target_id": 3, "weight": 0.8}, {"target_id": 4, "weight": 0.6}],  # Connections for neuron 1
    ...
    def test_step_simulation_with_fire_queue_refractory_and_consecutive(self, dict_core):
        ...
        dict_core["connectome"].get_connections_for_neuron = Mock(return_value=[
        ...
        with patch('feagi.npu.optimized_integration.step_simulation_with_fire_queue') as mock_step:
            ...
            def side_effect(core, mpf=True, puf=False, max_consecutive_fires=10):
                ...
                fire_queue = {
                    ...
                    "refractory_counters": [5, 0, 0, 0]  # Neuron 2 has refractory counter > 0
                }
...
class TestPropagateActivations:
    ...
    def test_propagate_activations_dict(self, dict_core):
        ...
        dict_core["connectome"].propagate_activations = Mock(side_effect=patched_propagate_activations)
...
class TestGetSetMembranePatential:
    ...
    def test_set_membrane_potential_optimized_rust(self):
        ...
        with patch('feagi.npu.optimized_integration.RUST_AVAILABLE', True):
            ...
            # Verify calls
            mock_core._rust_core.gna.set_membrane_potential.assert_called_once_with(42, 0.75)
