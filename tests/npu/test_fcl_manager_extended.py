...
class TestAdvancedFCLManagerFeatures:
    ...
    def test_get_neurons_fired_in_last_n_steps(self, setup_timesteps):
        ...
        # Test with specific cortical areas
        fired_area_100 = fcl_manager.get_neurons_fired_in_last_n_steps(3, cortical_indices=[100])
    ...
    def test_get_consistently_active_neurons(self, setup_timesteps):
        ...
        # Test with specific cortical areas
        consistent_area_100 = fcl_manager.get_consistently_active_neurons(3, cortical_indices=[100])
...
class TestEnhancedFCLManagerAdvancedFeatures:
    ...
    def setup_memory_cortical(self, enhanced_fcl_manager):
        ...
        for t in range(1, 8):
            enhanced_fcl_manager.update_fcl(t, {
    ...
    def test_advanced_error_handling(self, enhanced_fcl_manager):
        ...
        with pytest.raises(ValueError):
            ...
            enhanced_fcl_manager.get_memory_cortical_consistency(100, pattern_duration=5, window_duration=3)
        
        with pytest.raises(ValueError):
            # Non-memory cortical should raise an error
            enhanced_fcl_manager.get_memory_cortical_consistency(300, pattern_duration=2, window_duration=4)
        ...
        with pytest.raises(ValueError):
            enhanced_fcl_manager.register_memory_cortical(300, window_size=3)  # Smaller than default 