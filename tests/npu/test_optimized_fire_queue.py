...
class TestFireQueueProcess:
    ...
    @pytest.mark.skipif(
        not OPTIMIZED_AVAILABLE, reason="Optimized structures not available"
    )
    def test_fire_queue_process_rust(self, simple_network):
        ...
        step_simulation_with_fire_queue(
            simple_network, mpf=True, puf=False, max_consecutive_fires=10
        )
    ...
    def test_fire_queue_with_integration(self):
        ...
        # Step the simulation using the fire queue process
        step_simulation_with_fire_queue(
            core, mpf=True, puf=False, max_consecutive_fires=10
        )
    ...
    def test_psp_calculation(self, simple_network):
        ...
        # Step each network
        step_simulation_with_fire_queue(
            core1, mpf=True, puf=False, max_consecutive_fires=10
        )
        step_simulation_with_fire_queue(
            core2, mpf=False, puf=False, max_consecutive_fires=10
        )
        step_simulation_with_fire_queue(
            core3, mpf=True, puf=True, max_consecutive_fires=10
        )
    ...
    def test_consecutive_fire_limiting(self):
        ...
        step_simulation_with_fire_queue(
            core, mpf=True, puf=False, max_consecutive_fires=1
        )
