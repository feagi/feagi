...
from feagi.utils.zmq_debug import (
    ZMQDebugger, DebugLevel, MessageType,
...
class TestZMQDebuggerPerformance:
    ...
    def test_thread_safety(self):
        ...
        debugger = ZMQDebugger()
        debugger.enable_outbound(True)
        debugger.set_rate_limit(1000)  # High limit to avoid rate limiting during threading
        debugger.reset_stats()
...
class TestDebugRegressionPrevention:
    ...
    def test_legacy_compatibility(self):
        ...
        from feagi.utils.zmq_debug import (
            log_zmq_outbound, log_zmq_inbound, decode_zmq_data
        )
    ...
    def test_no_performance_regression(self):
        ...
        assert time_per_call < 0.00001, f"Fast path too slow: {time_per_call:.6f}s per call"
    ...
    def test_memory_efficiency(self):
        ...
        with patch('feagi.utils.zmq_debug.logger'):
            ...
            for i in range(1000):
                debugger.log_outbound(f"tcp://test:{5562+i%10}", b"data", MessageType.SENSORY)
