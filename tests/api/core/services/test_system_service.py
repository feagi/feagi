...
def mock_state_manager():
    ...
    sm.parameters = {
        "Limits": {
            "max_neuron_count": 10000,
            "max_synapse_count": 50000
        }
    }
    sm.user_preferences = {
        "adv_mode": True,
...
class TestSystemService:
    ...
    @pytest.mark.asyncio
    async def test_get_health_with_pending_amalgamation(self, system_service, mock_state_manager):
    ...
    def test_get_user_preferences_with_state_manager(self, system_service, mock_state_manager):
    ...
    def test_get_user_preferences_without_preferences_attr(self, system_service, mock_state_manager):
    ...
    def test_update_user_preferences_with_state_manager(self, system_service, mock_state_manager):
    ...
    def test_update_user_preferences_without_state_manager(self, system_service_no_state):
    ...
    def test_update_user_preferences_without_existing_preferences(self, system_service, mock_state_manager):
    ...
    def test_get_configuration_with_state_manager(self, system_service, mock_state_manager):
    ...
    def test_get_configuration_without_parameters(self, system_service, mock_state_manager):
    ...
    @patch('os.path.isdir')
    def test_set_circuit_library_path_valid(self, mock_isdir, mock_exists, system_service, mock_state_manager):
    ...
    @patch('os.path.exists')
    @patch('os.path.isdir')
    def test_set_circuit_library_path_not_directory(self, mock_isdir, mock_exists, system_service):
