...
def mock_connectome_manager():
    ...
    cm.synapses = {(1, 2): {"weight": 0.7}, (2, 3): {"weight": 0.9}}
    cm.cortical_areas = {
...
def mock_burst_engine():
    ...
    be.get_config.return_value = {"burst_frequency": 20.0, "max_burst_duration": 1.0}
    return be
...
class TestBrainService:
    ...
    def test_get_burst_engine_status_with_engine(
        self, brain_service, mock_state_manager
    ):
    ...
    def test_get_burst_engine_status_without_engine(
        self, brain_service, mock_state_manager
    ):
    ...
    def test_start_burst_engine_failure(self, brain_service, mock_state_manager):
        ...
        type(mock_state_manager).exit_condition = PropertyMock(
    ...
    def test_get_brain_statistics_with_state_manager(
        self, brain_service, mock_state_manager, mock_connectome_manager
    ):
        """Test getting brain statistics with state manager."""
        # Mock brain_stats to return proper values
        mock_state_manager.brain_stats = {"neuron_count": 100, "synapse_count": 200}
    ...
    def test_get_brain_statistics_without_state_manager(
        self, brain_service_no_state, mock_connectome_manager
    ):
    ...
    def test_get_activity_summary_with_state_manager(
        self, brain_service, mock_state_manager, mock_connectome_manager
    ):
    ...
    def test_reset_brain_state_with_state_manager(
        self, brain_service, mock_state_manager, mock_connectome_manager
    ):
    ...
    def test_get_performance_metrics_with_state_manager(
        self, brain_service, mock_state_manager
    ):
    ...
    def test_get_performance_metrics_without_state_manager(
        self, brain_service_no_state
    ):
    ...
    def test_get_burst_engine_config_with_engine(
        self, brain_service, mock_state_manager
    ):
    ...
    def test_brain_statistics_calculation(
        self, brain_service, mock_state_manager, mock_connectome_manager
    ):
        """Test that brain statistics are calculated correctly."""
        # Mock brain_stats properly
        mock_state_manager.brain_stats = {"neuron_count": 100, "synapse_count": 99}
    ...
    def test_stimulate_neurons_input_validation(
        self, brain_service, mock_connectome_manager
    ):
