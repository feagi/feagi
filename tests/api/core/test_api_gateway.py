...
class TestAPIGateway(unittest.TestCase):
    ...
    def test_singleton_pattern(self):
        ...
        self.assertIs(
            g1, g3, "Factory function should return the same singleton instance"
        )
    ...
    def test_gateway_properties(self):
        ...
        self.assertIs(
            gateway.core_api,
            mock_core_api,
            "core_api property should return the provided instance",
        )

        # Test zmq_client property
        self.assertTrue(
            hasattr(gateway, "zmq_client"), "Gateway should have zmq_client property"
        )
    ...
    def test_auto_initialization(self):
        ...
        with patch("feagi.api.gateway.api_gateway.logger") as mock_logger:
            ...
            self.assertIsNotNone(
                gateway.core_api, "core_api should be auto-initialized"
            )
    ...
    def test_authentication_methods(self):
        ...
        self.assertTrue(
            hasattr(gateway, "authenticate"), "Gateway should have authenticate method"
        )
        self.assertTrue(
            callable(gateway.authenticate), "authenticate should be callable"
        )

        # Simple authentication should work (placeholder implementation)
        self.assertTrue(
            gateway.authenticate({}), "Default authenticate should return True"
        )

        # Test authorize method
        self.assertTrue(
            hasattr(gateway, "authorize"), "Gateway should have authorize method"
        )
        ...
        self.assertTrue(
            gateway.authorize("test", "read", {}),
            "Default authorize should return True",
        )
    ...
    def test_route_request_method(self):
        ...
        self.assertTrue(
            hasattr(gateway, "route_request"),
            "Gateway should have route_request method",
        )
        self.assertTrue(
            callable(gateway.route_request), "route_request should be callable"
        )
    ...
    def test_rate_limiting(self):
        ...
        self.assertTrue(
            hasattr(gateway, "check_rate_limit"),
            "Gateway should have check_rate_limit method",
        )
        self.assertTrue(
            callable(gateway.check_rate_limit), "check_rate_limit should be callable"
        )

        # Default implementation should allow all requests
        self.assertTrue(
            gateway.check_rate_limit("client1", "/api/test"),
    ...
    def test_monitoring_methods(self):
        ...
        self.assertTrue(
            hasattr(gateway, "record_request"),
            "Gateway should have record_request method",
        )
        self.assertTrue(
            callable(gateway.record_request), "record_request should be callable"
        )
        ...
        self.assertTrue(
            hasattr(gateway, "get_metrics"), "Gateway should have get_metrics method"
        )
